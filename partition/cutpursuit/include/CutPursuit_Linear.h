...
class CutPursuit_Linear : public CutPursuit<T>
{
   ...
   // virtual ~CutPursuit_Linear();  
    ...
    CutPursuit_Linear(int nbVertex = 1) : CutPursuit<T>(nbVertex)
    {
    ...
    { // split the graph by trying to find the best binary partition
      // each components is split into B and notB
        ...
        std::vector< std::vector< std::size_t > > corners =
                std::vector< std::vector< std::size_t > >(this->components.size(),
    ...
    //=============================      COMPUTE CORNERS        ===================================
    //=============================================================================================
    inline void compute_corners(std::vector< std::vector< std::size_t > > & corners)
    { //-----compute the 2 most populous labels------------------------------
        ...
        for (std::size_t  i_com =0;i_com < this->components.size(); i_com++)
        {
            ...
            std::pair<std::size_t, std::size_t> corners_pair = find_corner(i_com);
    ...
    //=============================     find_corner        =======================================
    //=============================================================================================
    std::pair<std::size_t, std::size_t> find_corner(const std::size_t & i_com)
    {
        ...
        for(std::size_t i_dim=1; i_dim < this->dim; i_dim++)
        {
    ...
    //=============================       SET_CAPACITIES    =======================================
    //=============================================================================================
    inline void set_capacities(const std::vector< std::vector< std::size_t > > & corners)
    {
